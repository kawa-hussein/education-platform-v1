...
function shortTitle(code:string,title:string){
  const map:Record<string,string>={
    P01:"Executive Control Tower",P02:"Customer / Tenant 360",P03:"Sales CRM",P04:"Contracts",P05:"Plans & Entitlements",P06:"Subscriptions & Renewals",P07:"Provider Billing",P08:"Usage & Quotas",P09:"Tenant Provisioning",P10:"Implementation & Migration",P11:"Commercial Portal",P12:"Customer Success",P13:"Support & Service Desk",P14:"Privileged Support Access",P15:"SaaS Operations / SRE",P16:"Incidents & Change",P17:"Releases & Rollout",P18:"Security & Compliance",P19:"Backup & DR",P20:"Deployment & Isolation",P21:"Regions & Residency",P22:"Domains & White-label",P23:"Developer & Partner Platform",P24:"Customer Communications",P25:"Offboarding & Retention",P26:"Revenue Operations",P27:"SaaS Analytics",P28:"FinOps",P29:"Provider Roles",P30:"Provider Audit",P31:"Platform Protection",P32:"Product Feedback",P33:"Partners & Resellers",P34:"Legal & Assurance",P35:"Control-plane API",
...
export function Shell({children,page,onNavigate,user,lang,setLang,isPlatformOwner,tenants,selectedTenant,setSelectedTenant,branches,selectedBranch,setSelectedBranch,onLogout}:any){
  const providerPage=isPlatformOwner&&(page==="provider-dashboard"||page==="customers"||page==="customer-360"||page==="architecture"||page.startsWith("module-P"));
  ...
  const visibleGroups=useMemo(()=>groups.map(g=>({...g,entries:g.entries.filter(e=>!query.trim()||`${e.code} ${titleForCode(e.code)}`.toLowerCase().includes(query.trim().toLowerCase()))})).filter(g=>g.entries.length),[groups,query]);
  ...
  return <div className="app-shell enterprise-shell" dir={lang==="ar"||lang==="ku"?"rtl":"ltr"}>
    <aside className="sidebar enterprise-sidebar">
      ...
      <div className="sidebar-context-card">
        ...
        <small>{plane==="provider"?"Internal SaaS administration":selectedBranch?branches.find((b:any)=>b.id===selectedBranch)?.name||"Branch scope":"Group / all branches"}</small>
      </div>
